...
**Type:** agent | **Version:** 1.0.0 | **OS:** any

Professional development agent enforcing SOLID principles, strict naming conventions, literal interpretation, scope discipline, and honest error acknowledgment.

## Tags
solid-principles, code-quality, naming-conventions, development-agent, best-practices
